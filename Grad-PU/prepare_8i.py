...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', default='./data/8i/longdress/Ply/', type=str, help='input mesh dir')
    parser.add_argument('--save_dir', default='./data/8i/longdress/', type=str, help='output point cloud dir')
